...
MSG="fix(api): improve /api/test-openai with detailed error logging"
...
echo
echo "✅ Código atualizado e enviado para $BRANCH."
echo "Assim que o Preview do Vercel ficar pronto, teste em:"
