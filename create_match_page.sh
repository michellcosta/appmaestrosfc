...
if [ -f "src/pages/Match.tsx" ]; then
  cp -f "src/pages/Match.tsx" "src/pages/Match.tsx.bak"
  echo "��� Backup criado: src/pages/Match.tsx.bak"
fi

# Escreve o novo arquivo
cat > src/pages/Match.tsx <<'EOF'
...
echo "✅ src/pages/Match.tsx atualizado com placar de 2 times e rodízio."
echo "Se algo sair errado, seu backup está em: src/pages/Match.tsx.bak"
