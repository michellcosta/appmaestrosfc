...
COMMIT_MSG="fix(api): convert /api/test-openai para JavaScript puro"
...
# Remove a versão antiga em TS, se existir
...
echo
echo "✅ Corrigido para JavaScript. Agora rode localmente:"
echo "   vercel dev"
echo "e teste: http://localhost:3000/api/test-openai"
