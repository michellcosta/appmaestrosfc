-- ============================================
-- Nexus Play - CORREÇÃO DEFINITIVA DO OWNER
...
-- 4. SOLUÇÃO: Remover constraint temporariamente
ALTER TABLE public.groups ALTER COLUMN owner_id DROP NOT NULL;

-- 5. Atualizar o grupo com seu owner_id
UPDATE public.groups 
SET owner_id = auth.uid()
WHERE name = 'Grupo Padrão';

-- 6. Restaurar constraint
...
-- 8. Criar membership como owner para você
...
-- 10. Verificar carteira do grupo
SELECT 
  w.group_id,
  w.balance_cents,
  CASE 
