...
MSG="feat(api): diagnostics for /api/test-openai (key type & fix hints)"
...
echo
echo "✅ Diagnóstico aplicado em /api/test-openai e enviado para $BRANCH."
echo "Abra o Preview da branch e acesse: https://<preview-url>.vercel.app/api/test-openai"
echo "O JSON vai indicar o tipo da chave (project/user), status HTTP e dicas de correção."
