...
export const pt = {
  ...
  match: {
    ...
    approachField: 'Aproxime-se do campo (≤ 30 m)',
    weakGpsSignal: 'Sinal fraco — tente céu aberto',
    confirmDraw: 'Confirmar sorteio?',
    confirmRedraw: 'Refazer o sorteio?',
    playersPerPosition: 'Jogadores por posição',
    scoreGoal: 'Marcar Gol',
    author: 'Autor',
    assist: 'Assistência',
    optional: 'Opcional',
    correctGoal: 'Corrigir Gol',
    winner: 'Vencedor',
  },
  ...
  financial: {
    ...
    generatePix: 'Gerar Pix — Copiar',
    monthlyPayment: 'Pagamento Mensalista Maestros FC',
    dailyPayment: 'Pagamento Diarista Maestros FC',
    dueDate: 'Vencimento',
    credits: 'Créditos',
    refund: 'Reembolso',
    creditMessage: 'Partida lotou durante o pagamento. Valor creditado para próximo jogo.',
    noShowWarning: 'Atenção: não haverá reembolso em caso de ausência.',
