...
import ForceSaveUser from '@/components/ForceSaveUser';
import RecreateOwner from '@/components/RecreateOwner';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-emerald-100 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="shadow-2xl border-0 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-lg rounded-2xl border border-white/20 dark:border-zinc-800/50">
          ...
          <div className="space-y-6 px-8 pb-8">
            ...
            {/* Message Display */}
            {message && (
              <div className={`p-4 rounded-xl ${message.includes('❌')
                ? 'bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-800'
                : 'bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-800'
                }`}>
                <p className={`text-sm font-medium text-center whitespace-pre-line ${message.includes('❌')
      ...
      {/* Componente para recriar owner */}
      <RecreateOwner />

      {/* Componente para debug de usuários */}
      <ForceSaveUser />
